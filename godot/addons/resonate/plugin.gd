...
func _enter_tree():
	...
	add_custom_type(
		"SoundBank",
		"Node",
		preload("sound_manager/sound_bank.gd"),
		preload("sound_manager/sound_bank.svg")
	)
	add_custom_type(
		"MusicBank",
		"Node",
		preload("music_manager/music_bank.gd"),
...
func migrate_old_bus_settings():
	...
	if ProjectSettings.has_setting("audio/manager/sound/bank"):
		var value = ProjectSettings.get_setting(
			"audio/manager/sound/bank", _settings.SOUND_BANK_BUS_SETTING_ACTUAL
		)
	...
	if ProjectSettings.has_setting("audio/manager/music/bank"):
		var value = ProjectSettings.get_setting(
			"audio/manager/music/bank", _settings.MUSIC_BANK_BUS_SETTING_ACTUAL
		)
